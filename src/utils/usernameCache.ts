 ...
 */
export const createAddToCache = (setter: React.Dispatch<React.SetStateAction<Set<string>>>) => {
 ...
 */
export const createRemoveFromCache = (setter: React.Dispatch<React.SetStateAction<Set<string>>>) => {
...
export const needsValidation = (
  ...
  const { needValidation } = categorizeUsernames(usernames, validatedCache, invalidCache);
